# SSTIM ontology — frozen snapshot 0.12.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.12.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.12.0>` resolves to a frozen
...
- Source commit: `935e034718e7c6ce11de58c68eeaac6a8d845bc1`
...
Files: `sstim-core.ttl`, `sstim-vocab.ttl`, `sstim-shapes.ttl`, `sstim-alignments.ttl`, `sstim-patch-studio.ttl`, `sstim-exposure.ttl`, `sstim-stimulus.ttl`, `sstim-ecosystem.ttl`.
