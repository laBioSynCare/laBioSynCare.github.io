# SSTIM ontology — frozen snapshot 0.18.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.18.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.18.0>` resolves to a frozen
...
`https://w3id.org/sstim/0.18.0` resolves to, because `sstim-core.ttl` is
...
- Source commit: `ab829e504bb725f0f35edaa16942fc1d0425644c`
