# SSTIM ontology — frozen snapshot 0.9.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.9.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.9.0>` resolves to a frozen
...
- Source commit: `a9156d487649ff83e3354532760a4811d1aba279`
