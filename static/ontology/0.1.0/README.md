# SSTIM ontology — frozen snapshot 0.1.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.1.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.1.0>` resolves to a frozen
...
- Source commit: `279c518667e6985fe5fb6ccb4a6d6b29cc433c77`
