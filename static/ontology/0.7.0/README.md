# SSTIM ontology — frozen snapshot 0.7.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.7.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.7.0>` resolves to a frozen
...
- Source commit: `0c62181880551395904f74aefb584b48c4268524`
