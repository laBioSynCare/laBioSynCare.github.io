# SSTIM ontology — frozen snapshot 0.15.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.15.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.15.0>` resolves to a frozen
...
`https://w3id.org/sstim/0.15.0` resolves to, because `sstim-core.ttl` is
...
- Source commit: `4c496a562a1226eaa87c73191f7d441d84ba317e`
