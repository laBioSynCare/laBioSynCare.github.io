# SSTIM ontology — frozen snapshot 0.17.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.17.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.17.0>` resolves to a frozen
...
`https://w3id.org/sstim/0.17.0` resolves to, because `sstim-core.ttl` is
...
- Source commit: `c7d677bf09abbf52f81ba2960e023fd5cb13948d`
