# SSTIM ontology — frozen snapshot 0.8.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.8.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.8.0>` resolves to a frozen
...
- Source commit: `f5713ce8f8c77f7b610d1b34f83f645d71a8b771`
