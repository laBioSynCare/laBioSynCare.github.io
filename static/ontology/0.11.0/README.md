# SSTIM ontology — frozen snapshot 0.11.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.11.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.11.0>` resolves to a frozen
...
- Source commit: `41ee0b3889299347eb42cee4cc158d3bf72e9619`
...
Files: `sstim-core.ttl`, `sstim-vocab.ttl`, `sstim-shapes.ttl`, `sstim-alignments.ttl`, `sstim-patch-studio.ttl`, `sstim-exposure.ttl`, `sstim-ecosystem.ttl`.
