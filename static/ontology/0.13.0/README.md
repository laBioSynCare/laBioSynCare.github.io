# SSTIM ontology — frozen snapshot 0.13.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.13.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.13.0>` resolves to a frozen
...
`https://w3id.org/sstim/0.13.0` resolves to, because `sstim-core.ttl` is
...
- Source commit: `cdf01ebe8a0ceb0b0e395493193d424f585c8d23`
