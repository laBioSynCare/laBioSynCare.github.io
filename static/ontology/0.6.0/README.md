# SSTIM ontology — frozen snapshot 0.6.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.6.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.6.0>` resolves to a frozen
...
- Source commit: `b8be6690dc27303a0803bf6d4509f8672dc64a55`
