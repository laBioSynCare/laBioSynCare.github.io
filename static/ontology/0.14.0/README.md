# SSTIM ontology — frozen snapshot 0.14.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.14.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.14.0>` resolves to a frozen
...
`https://w3id.org/sstim/0.14.0` resolves to, because `sstim-core.ttl` is
...
- Source commit: `db42688be258142aa4c9ecac346b0b33b20ce4b7`
