# SSTIM ontology — frozen snapshot 0.10.0

These files are a **byte-identical, immutable copy** of the SSTIM ontology as of
version `0.10.0`. They exist so that
`owl:versionIRI <https://w3id.org/sstim/0.10.0>` resolves to a frozen
...
- Source commit: `6be2037a103821dbea1a454b14f1a2ca2c01c96a`
