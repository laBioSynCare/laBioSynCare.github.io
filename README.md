...
- **Latest immutable release:** SSTIM `v0.8.0`, archived at
  [10.5281/zenodo.21462727](https://doi.org/10.5281/zenodo.21462727) and
  identified by `https://w3id.org/sstim/0.8.0`.
- **All-version DOI:**
...
For the released ontology, cite SSTIM `v0.8.0` using
[10.5281/zenodo.21462727](https://doi.org/10.5281/zenodo.21462727). Its stable
version IRI is `https://w3id.org/sstim/0.8.0`. Use the
