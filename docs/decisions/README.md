...
| [0034](0034-neuromodulation-relation-and-neural-target-axis.md) | Neuromodulation overlaps (does not subsume) sensory stimulation; route/target/effect kept separate; retire the SHACL editorialNote escape hatch | Proposed |
