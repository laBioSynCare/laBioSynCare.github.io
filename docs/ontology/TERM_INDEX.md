...
| `sstim:citesReference` | object | evidence | sstim:EvidenceClaim → sstim:BibliographicReference | Links an evidence assessment to a bibliographic reference. For every bibliographic basis source the assessment carries a matching citesReference… |
...
| `sstim:signalSourceAsset` | object | stimulus | sstim:StimulationSignal → IAO_0000030 | The recorded material a sampled signal is taken from — a violin note, a voice, rainfall. Required when the shape is sampled and meaningless… |
