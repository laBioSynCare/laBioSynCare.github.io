...
**2026-09-05: 0 of 32. 2026-09-06: 29 of 32, then 37 of 41. 2026-09-07: 54 of 58.** The first inbound term-level
...
Alignment tranche 2 then widened the mapped set to 41 items and a second batch
carried eight of them, so the count is 37 of 41. The four still unlinked are the
`relatedMatch` rows held back by design: `Q863539` binaural beats, `Q17166073`
multisensory integration, `Q4826866` ASMR and `Q76299` visible spectrum. See §3 of
[WIKIDATA_CONTRIBUTION.md](WIKIDATA_CONTRIBUTION.md) for why.
