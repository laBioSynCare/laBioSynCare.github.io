...
- rdflib reads 12,321 triples: exactly one `owl:Ontology`, the correct
  `owl:versionIRI` of the submitted release, `https://w3id.org/sstim/0.17.0`, zero illegal property punning,
...
```text
$ curl "https://api.openaire.eu/search/software?doi=10.5281/zenodo.22921183"
