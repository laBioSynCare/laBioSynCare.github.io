...
- [x] Request HED Working Group review. Sent 2026-08-20 as six questions split by owning repository: [hed-schemas#416](https://github.com/hed-standard/hed-schemas/issues/416) and [hed-javascript#836](https://github.com/hed-standard/hed-javascript/issues/836). @VisLab, @neuromechanist and @yarikoptic replied; Kay Robbins then met with Renato on 2026-08-25. Item 2 is settled, item 1 half settled, and item 3 answered by the meeting. Items 4 and 5 and VisLab's definition-shape question remain open. The item 6 fix [bids-validator#442](https://github.com/bids-standard/bids-validator/pull/442) merged 2026-08-27 and passed re-test; #836 remains open for residual error presentation. Renato sent the requested 11-event follow-up on 2026-08-28; its privacy-safe [sent record](../ontology/outreach/2026-08-28-kay-robbins-sent-record.md) is distinct from the unsent 30-event alternate. Recorded in [ADR 0025](../decisions/0025-hed-bids-interoperability-crosswalk.md#hed-working-group-answers-and-review-2026-08-20-to-2026-08-28).
