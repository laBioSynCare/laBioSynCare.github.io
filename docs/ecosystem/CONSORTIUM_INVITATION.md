...
## Briefing for prospective participants
...
- Participate in approximately one monthly video call (optional) and occasional
  async review of vocabulary additions via GitHub Issues
- Optionally co-author publications describing the vocabulary and its rationale
...
If you are interested, I would welcome a 30-minute call to discuss the scope
and answer any questions. Alternatively, please find the draft charter at
[LINK] and the ontology documentation at https://w3id.org/sstim.
...
- [ ] Confirm with Renato Fabbri that timing is appropriate
- [ ] After sending: log date sent in this document under "Outreach log"

---

## Outreach log

| Date | Recipient | Institution | Response | Status |
|---|---|---|---|---|
