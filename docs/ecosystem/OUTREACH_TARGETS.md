...
|---|---|---|---|
| Standards | **HED Working Group** (INCF-endorsed) | Review one SSTIM–HED/BIDS worked example | **engaged** — contacted 2026-08-20 through [hed-schemas#416](https://github.com/hed-standard/hed-schemas/issues/416) and [hed-javascript#836](https://github.com/hed-standard/hed-javascript/issues/836); three maintainers replied inside 48 h, and Kay Robbins met with Renato on 2026-08-25. Item 2 is settled, item 1 half settled, and item 3 answered by the meeting; items 4 and 5 and the definition-shape question remain open. Mapping 0.5.0 implements the pause/resume ruling. The item 6 fix, [bids-validator#442](https://github.com/bids-standard/bids-validator/pull/442), merged 2026-08-27 and passed re-test; #836 remains open for residual error presentation. Renato sent the requested 11-event follow-up on 2026-08-28; see its privacy-safe [sent record](../ontology/outreach/2026-08-28-kay-robbins-sent-record.md). See [ADR 0025](../decisions/0025-hed-bids-interoperability-crosswalk.md) |
