...
| G2 | S2 | Expert review | Event annotation standards | ADR 0025 HED mapping: review one SSTIM to HED worked example | HED Working Group | in `OUTREACH_TARGETS.md` | engaged — public replies from three maintainers and 2026-08-25 meeting with Kay Robbins; follow-up drafted, not sent |
