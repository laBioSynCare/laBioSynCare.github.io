<script>
  ...
  import CanonicalLink from '../ui/seo/CanonicalLink.svelte'
...
<style>
  ...
  :global(:root[data-skin='midnight']) {
    ...
    --app-canvas: #0b0b0c;
    --app-surface: #111820;
    --app-surface-2: #161f2a;
    --app-surface-3: #1b2633;
    --app-border: #243447;
    --app-border-subtle: #ffffff18;
    --app-text: #d7e1ec;
    --app-text-strong: #f1f6fb;
    --app-muted: #8292a7;
    --app-muted-2: #53687a;
    --app-accent: #3b9eff;
  ...
  :global(:root[data-skin='aurora']) {
    ...
    --app-canvas: #071012;
    --app-surface: #102026;
    --app-surface-2: #142b32;
    --app-surface-3: #193741;
    --app-border: #24505b;
    --app-border-subtle: #8de7dc24;
    --app-text: #d9f6f2;
    --app-text-strong: #f5fffd;
    --app-muted: #8fb4bc;
    --app-muted-2: #5c7f88;
    --app-accent: #42d3c8;
  ...
  :global(:root[data-skin='ember']) {
    ...
    --app-canvas: #0d0b09;
    --app-surface: #1b1712;
    --app-surface-2: #231d16;
    --app-surface-3: #2d241a;
    --app-border: #4a3927;
    --app-border-subtle: #ffbe6320;
    --app-text: #efe3d1;
    --app-text-strong: #fff6e8;
    --app-muted: #a88f73;
    --app-muted-2: #765f48;
    --app-accent: #ffad3b;
